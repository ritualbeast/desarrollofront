...
const NuevaEncuesta = ({
  ...
  seccionVisibleInit,
    ...
    const handleOptionMultiple = (index, preguntas, saveValue = false, cancelarValue = '') => {
      ...
      const contenidoActual = nuevoEstado[seccionIndex]?.contentPreg || [];
      ...
      nuevoEstado[seccionIndex].contentPreg = contenidoActual;
    ...
    const handleAceptarCuadroComentarios = (indicePreg, indiceSec, pregunta, opcionesRespuesta, cancelar) => {
      const nuevoEstado = [...contentCont];
      const contenidoActual = [...nuevoEstado[indiceSec].contentPreg];
      contenidoActual[indicePreg].pregunta = pregunta
      contenidoActual[indicePreg].opcionesRespuesta = opcionesRespuesta
    ...
    <>
        <Container className='encuesta-Tercerocuerpo2-1'>
            <Col className='contendor-de-EncuestaVeris'>
              ...
              {showModal && <SeccionCierre
                seccionVisibleInit={seccionVisible}
                handleCancelarCierre={handleCancelarSeccionCierre}
                handleGuardarCierre={handleGuardarSeccionCierre}
              />}
